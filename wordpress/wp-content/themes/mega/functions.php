...
function mega_scripts() {
	...
	// wp_enqueue_script( 'mega-input', $get_template_directory_uri . '/public/js/libs.js', array('jquery'), '20200325', true );
	wp_enqueue_script( 'mega-libs', $get_template_directory_uri . '/public/libs/inputmask/inputmask.min.js', array('jquery'), '20200325', true );
	wp_enqueue_script( 'mega-swiper', $get_template_directory_uri . '/public/libs/swiper/swiper-bundle.min.js', array('jquery'), '20200325', true );
	wp_enqueue_script( 'timer',  $get_template_directory_uri . '/public/js/timer_universal.js?3', array('jquery'), '20200325', true );
	wp_enqueue_script( 'mega-Popup', $get_template_directory_uri . '/public/libs/@fancyapps/fancybox/jquery.fancybox.min.js', array('jquery'), '20200325', true );
	...
	wp_enqueue_script( 'commont', $get_template_directory_uri . '/public/js/common.js', array('jquery'), '20200325', true );
